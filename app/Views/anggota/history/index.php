                        ...
                        <?php foreach ($model as $key => $value): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <!-- View details book-->
                                    <div class="btn-group">
                                        <a href="<?= base_url() . 'peminjaman/kembali/' . $value['id_buku'] ?>"
                                            class="btn btn-warning btn-sm text-white <?= ($value['status'] == 'Pending' || $value['status'] == 'Ditolak' || $value['status'] == 'Sudah Kembali') ? 'disabled' : '' ?>">
